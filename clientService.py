...
from com_in_pybron_speech_to_text.transcriptGenerator import generateTranscript
from com_in_pybron_spellingcorrector.spellcorrector import spell_corrector
from com_in_pybron_keywordspotter.keywordSpotter import AddMultiKeywords
